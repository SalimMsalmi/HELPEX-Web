...
class CaisseOrganisationController extends AbstractController
{
    ...
    #[Route('/new/{id}', name: 'app_caisse_organisation_new', methods: ['GET', 'POST']), IsGranted('ROLE_ADMIN')]
    ...
    #[Route('/{id}/edit', name: 'app_caisse_organisation_edit', methods: ['GET', 'POST']), IsGranted('ROLE_ADMIN')]
    ...
    #[Route('/{id}', name: 'app_caisse_organisation_delete', methods: ['POST']), IsGranted('ROLE_ADMIN')]
