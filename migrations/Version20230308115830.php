 ...
 */
final class Version20230308115830 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE accompagnement (id INT AUTO_INCREMENT NOT NULL, task_id INT NOT NULL, user_id INT NOT NULL, user_pro_id INT DEFAULT NULL, is_accepted TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_2130A05B8DB60186 (task_id), INDEX IDX_2130A05BA76ED395 (user_id), INDEX IDX_2130A05BA6E5FF87 (user_pro_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, filiere_id INT DEFAULT NULL, accompagnement_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, sexe VARCHAR(255) NOT NULL, adresse LONGTEXT NOT NULL, num_tel VARCHAR(255) NOT NULL, pdp VARCHAR(255) DEFAULT NULL, bio LONGTEXT NOT NULL, date_naissance DATE DEFAULT NULL, diplome LONGTEXT DEFAULT NULL, tarif DOUBLE PRECISION DEFAULT NULL, is_enabled TINYINT(1) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649180AA129 (filiere_id), INDEX IDX_8D93D6498E768805 (accompagnement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
